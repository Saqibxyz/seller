...
// //   const [confirmMap, setConfirmMap] = useState({}); // stores confirmation state per order
...
// //     setConfirmMap((prev) => ({ ...prev, [orderId]: true }));
// //   };
...
// //         Your Picked Order History
// //       </h1>

// //       {orders.length === 0 ? (
// //         <div className="text-center text-gray-500">
// //           No picked order history found.
// //         </div>
// //       ) : (
...
// //                   {!confirmMap[order._id] ? (
// //                     <button
// //                       onClick={() => handleDeliverClick(order._id)}
// //                       className="bg-[#6d46fa] hover:bg-[#5a38db] text-white px-4 py-2 rounded-md shadow-md transition"
// //                     >
// //                       Mark as Delivered
// //                     </button>
// //                   ) : (
// //                     <div className="bg-[#f3f0ff] p-3 rounded-md border border-[#d9d3f7]">
...
//                   Awaiting delivery confirmation from delivery agent...
//                 </div>
//               )}
//             </div>
//           ))}
